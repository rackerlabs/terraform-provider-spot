	...
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			...
			"names": schema.ListAttribute{
				...
				MarkdownDescription: "List of region names matching to the filters if provided. If no filters are provided, all the regions are returned.",
			},
		},
	}
}
